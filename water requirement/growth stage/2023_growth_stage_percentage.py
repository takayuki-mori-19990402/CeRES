# -*- coding: utf-8 -*-
"""
Created on Sat May 25 18:30:14 2024
...
# 例としてデータフレームを作成
path_area = r"C:\Users\HONGO-23\Desktop\data\ndvi_max day\csv\2023\20230723_growth_stage.csv"
df = pd.read_csv(path_area)
#print(df)


# 対象の成長値
growth_values = [3, 4, 5, 6, 7, 8, 9]
...
print(result_df)
result_df.to_csv(r"C:\Users\HONGO-23\Desktop\data\ndvi_max day\csv\2023\20230723_growth_stage_percentage.csv")
...
# 積み上げ棒グラフを作成
#colors = [ 'magenta', 'blue', 'darkorchid', 'orange', 'yellow', 'red', 'red']
colors = [ 'darkorchid', 'blue' , 'white', 'orange', 'magenta', 'orange', 'yellow']
