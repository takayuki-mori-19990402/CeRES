# -*- coding: utf-8 -*-
"""
Created on Thu May 23 13:55:59 2024
...
head_path = r"C:\Users\HONGO-23\Desktop\data\ndvi_max day\csv\2023\2023_heading_date.csv" ## 変更
...
date_range = pd.date_range(start='2023/4/9', end='2023/9/26', freq='D')                 ##変更
counts = df_head['Max_Date'].value_counts().reindex(date_range, fill_value=0)

# カウントが0以上の日付のみを取得
valid_dates = counts[counts > 3000]                                                      ##変更
...
for label in xticklabels:
    if label.get_text() == '07/08':  ##変更
        label.set_color('red')
        label.set_fontweight('bold')

# グラフの保存
plt.savefig(r"C:\Users\HONGO-23\Desktop\data\ndvi_max day\fig\2023_count_3000.jpeg", dpi=200) #変更
