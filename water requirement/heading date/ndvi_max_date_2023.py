# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 19:36:47 2024
...
csv_path = glob.glob(r"\\HONGO-S1\Hongo-lab2\Data\Sentinel-2\Cihea\parcel\2023\*.csv")
...
#df_sg.to_csv("/Users/moritakayuki/Desktop/jupyter_notebook/2022_NDVI_SavitzyGolay.csv")
...
plt.title('Count of Entries by Date 2023/4/9-9/26')
plt.xlabel('Date')
plt.ylabel('Count')
plt.ylim(0,40000)
